...
class SzSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for unit in self.units:
            print "==========================="
            print "current search number:" + str(unit.number)
            print "==========================="
            ...
            try:
                ...
                for tab in tabs:
                    if tab != searching:
                        ...
                        qichachca.BaseInfo(response, unit.number)

                        qichachca.Unit_Base_Shareholder_Info(response, unit.number)

                        qichachca.Unit_Base_Changed_Info(response, unit.number)
