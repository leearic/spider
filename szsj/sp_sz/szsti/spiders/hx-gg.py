...
class SzSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        self.Base_Request_Url = 'http://stockdata.stock.hexun.com/gszl/ggml-'
    ...
    def parse(self, response):
        ...
        for unit in self.units:
            ...
            print u"高管 search id: " + unit.Code
            print "*" * 30
            ...
            hexun_Analysis.Gaoguan_Info(response, str(unit.Code))
            hexun_Analysis.Dongshi_Info(response, str(unit.Code))
            hexun_Analysis.Jianshi_Info(response, str(unit.Code))
